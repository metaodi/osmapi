...
- The documentation is no longer committed to the repository: the generated `docs/` folder has been removed and git-ignored, a new `publish_docs.yml` GitHub Action builds it with `pdoc` and deploys it to GitHub Pages on every push to `main`
