...
class OsmApi:
    ...
    def _get(self, path):
        return self._http(self._conn.get, path, False, None)

    def _put(self, path, data):
        return self._http(self._conn.put, path, True, data)
    ...
    def _post(self, path, data, optionalAuth=False):
        ...
        return self._http(self._conn.post, path, auth, data)

    def _delete(self, path, data):
        return self._http(self._conn.delete, path, True, data)
