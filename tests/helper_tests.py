...
class TestOsmApiHelper(osmapi_tests.TestOsmApi):
    ...
    def setupMock(self, status=200):
        ...
        self.api._session.get = mock.Mock(return_value=mock_response)
        self.api._session.put = mock.Mock(return_value=mock_response)
